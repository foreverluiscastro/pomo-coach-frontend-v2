...
function BarGraph({ data }) {
  const daysOfWeek = ["Su", "M", "Tu", "W", "Th", "F", "Sa"]; // Starting from Sunnday
    ...
    <div className="flex flex-col overflow-x-auto w-full">
      <div className="flex justify-between pl-4">
        {daysOfWeek.map((day, index) => {
          // Adjust index to match the current day of the week starting from Sunday
          const adjustedIndex = (currentDateIndex + 7) % 7;
